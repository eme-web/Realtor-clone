...
export default function CreateListing() {
    ...
    const {type, name,  bedrooms, bathrooms, parking, address, furnished, description, offer, 
   ...
   return (
    <main className='max-w-md px-2 mx-auto'>
        ...
        <form onSubmit={onSubmit}>
            ...
            {!geolocationEnabled && (
                <div className="flex space-x-6 justify-start mb-6">
                    <div className=''>
                        ...
                        required min="-90" max="90" className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus:border-slate-600 text-center" />
                    </div>
                    <div className=''>
                        <p className="text-lg font-semibold">Longitude</p>
                        <input type="number" id="longitude" value={longitude} onChange={onChange} 
                        required min="-180" max="180" className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus:border-slate-600 text-center" />
                    </div>
                </div>
            )}
         ...
         <div className='mb-6'>
            <p className='txt-lg font-semibold'>Images</p>
